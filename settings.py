...
DISTRIBUTION_NAME = "notused"

SOURCE_FLAG='repo' # folder/repo
REPO_URL = "https://github.com/integrate/pygame_wrap1"
REPO_BRANCH = "build_ext"
REPO_FOLDER = "C:\\Users\\vmatv\\PycharmProjects\\pygame_wrap1"

SOURCE_PATH = "src/"+EXT_NAME #конечная папка должна совпадать с именем EXT_NAME. Иначе будет ошибка при сборке.
